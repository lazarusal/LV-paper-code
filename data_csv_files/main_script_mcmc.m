...
function main_script_mcmc(num_near)
    ...
    mult_out_paths;
    sav_dir_res=strcat('/home/alan/PhD/data/rssc_emulation/integrated/mcmc_results/k',num2str(n_near)); %please change accordingly where results should save
    sav_dir_rough=strcat('/home/alan/PhD/data/rssc_emulation/integrated/sampled_roughness/k',num2str(n_near)); %please change accordingly where results should save
    %%
    ...
    'mcmc','function_local', yTest(NUMBERINDICATOR,:),5,2000,'mh');
